...
export async function finalize(candidatePath,finalPath,revision='final'){
 return finalizePresentation({workspaceDir:ROOT,candidatePath,finalPath,pythonExecutable:PY,
  ...
  layoutArgs:['--expected-slide-size-emu','12192000,6858000','--validate-heading-fit','--require-native-table-slide','9','--require-native-table-slide','12'],
  explicitTotalSlideCount:18,requiredNativeTableOwnerSlides:[9,12],requiredNativeChartOwnerSlides:[11,14,17],
...
export async function renderFinal(finalPath){
 ...
 if(deck.slides.items.length!==18)throw Error('Expected eighteen slides');
