...
with zipfile.ZipFile(deck) as z:
 ...
 visible='\n'.join(texts)
 for stale in ['附录','单场收入与成本','Clipping与Content Rewards','工时敏感度','退出','剪辑者','品牌','110,000','RM180','尚未批准募资额']:assert stale not in visible,stale
 for expected in ['真实观看','病毒式传播','Organic','商家应付奖励 RM2,000','已支付 RM0','拟议','RM70,000','RM0','订阅','增值工具收费']:assert expected in visible,expected
...
old=json.loads((r.parent/'content-rewards-business-v8/delivery-check.json').read_text());assert sha(f)==old['finance_sha256']
